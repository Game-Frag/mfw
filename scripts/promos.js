...
/**
 * Sets the mode of the Game-Frag Promos UI
...
/**
 * Create a new 'Game-Frag Promos' code with a webworker
...
/** Export and download all Game-Frag Promos data in to a CSV format */
export async function promosToCSV() {
    const arrCSV = [
        // Titles
        ['Promo Code', 'FRAG (Remaining)', 'Funding Address'],
        // Content
    ];
...
/**
 * @type {Worker?} - The thread used for the Game-Frag Promos redeem process
 */
export let promoThread = null;

/**
 * Derive a 'Game-Frag Promos' code with a webworker
...
/**
 * Prompt a QR scan for a Game-Frag Promos code
 */
