    ...
    for (const cProposal of arrProposals) {
        ...
        if (cProposal.local) {
            ...
            <span style="font-size:12px; line-height: 15px; display: block; margin-bottom:15px;">
                ...
                <span style="color:#f23030;">(${strFundingStatus})</span><br>
            </span>
        ...
        domNameAndURL.innerHTML = `<a class="governLink" style="color: white" href="${sanitizeHTML(
            ...
            cProposal.Name
        )} <span class="governLinkIco"><i class="fa-solid fa-arrow-up-right-from-square"></i></b></a></span><br><a class="governLink" style="font-size: small; color:#f23030;" onclick="MPW.openExplorer('${
        ...
        <b class="governFiatSize">(${strProposalCurrency} <span style="color:#f23030;">${strCurrency.toUpperCase()}</span>)</b></span>
        ...
        html: `<input id="proposalTitle" maxlength="20" placeholder="${
            translation.popupProposalName
               ...
               <input id="proposalUrl" maxlength="64" placeholder="${
                   translation.popupExample
               } https://www.game-frag.com/forums/..." style="text-align: center;"><br>
