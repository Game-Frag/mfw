export default {
    ...
    // Footer
    footerBuiltWithPivxLabs: 'Built with wuv by Game-Frag 💜', //Built with 💜 by Game-Frag

    // Intro
    loading: 'Loading', //
    loadingTitle: 'My Game-Frag Wawwet is', //
    ...
    dCardOneDesc:
        'Cweate a new Game-Frag wawwet, offewing da most secuwur backup & securrrity methods.', //Create a new Game-Frag wallet, offering the most secure backup & security methods.
    ...
    dCardTwoDesc:
        'Cweate a wawwet wiv a custom pwefix, dis can take a long twime!', //Create a wallet with a custom prefix, this can take a long time!
    ...
    dCardThreeDesc:
        "Use ur Ledger Hardware wawwet wiv MFW's famiwiar intwerface.", //Use your Ledger Hardware wallet with MFW's familiar interface.
    dCardThreeButton: 'Access my Ledger', //Access my Ledger

    dCardFourTitle: 'Go to', //Go to
    dCardFourSubTitle: 'My Wawwet', //My Wallet
    dCardFourDesc:
        'Impowt a Game-Frag wawwet using a Pwivate Key, xpriv, or Seed Phrase.', //Import a Game-Frag wallet using a Private Key, xpriv, or Seed Phrase.
    ...
    encryptFirstForContacts:
        'Once yew hit "{button}" in the Dashboard, yew can cweate a Contact to make receiving FRAG easier!', //Once you hit "{button}" in the Dashboard, you can create a Contact to make receiving FRAG easier!
    ...
    pivxPromos: 'is a decentralised system for gifty cowodes worth FRAG', // [...] is a decentralised system for gift codes worth FRAG
    // NOTE: on this line, if possible, leave 'Game-Frag Promos' untranslated
    redeemInput: "Enter ur 'Game-Frag Promos' cowode", //Enter your 'Game-Frag Promos' code
    ...
    settingsPivxNode: 'Chowose a Game-Frag nowode pwease:', //Choose a Game-frag node:
    ...
    time_to_sync: 'The time in seconds it took for MFW to last synchronise.♡', //The time in seconds it took for MFW to last synchronise.
    transaction:
    ...
    popupSeedPhraseBadNote:
        'The seed phwase iz either invalid, or was nawt generated by MFW.<br>Do yew still want to pwroceed?', //The seed phrase is either invalid, or was not generated by MFW.<br>Do you still want to proceed?
    ...
    popupProposalFinalisedSignoff:
        'Good lucky on ur journey through the DAO, Senpai!', //Good luck on your journey through the DAO!
    ...
    PASSWORD_TOO_SMALL:
        'Dat password is a wittle short!<br>Pwease use at least<b> {MIN_PASS_LENGTH} chawacters!</b>', //"That password is a little short!<br>Use at least <b>" + MIN_PASS_LENGTH + " characters.</b>",
    PASSWORD_DOESNT_MATCH: 'Yowour passwords dun match!! baka!!', //'Your passwords don\'t match!',
    NEW_PASSWORD_SUCCESS:
        "<b>Yowou're Secuwed!</b><br>Good Job, Game-Frag Pogchamp!", //'<b>You\'re Secured! 🔐</b><br>Nice stuff!',
    ...
    INVALID_ADDRESS: '<b>Invawed Game-Frag addwess baka</b><br> {address} ', //<b>Invalid Game-Frag address!<b><br> {address}
    ...
    CONFIRM_TRANSACTION_H_WALLET:
        '<b>Confirm yowoure twansaction</b><br>Confirm da TX on yowour {strHardwareName}', //"<b>Confirm your transaction</b><br>Confirm the TX on your ",
    SUCCESS_STAKING_ADDR_SET:
        '<b>Staking Addwess set!~</b><br>Now go ahead and stake senpai❣', //'<b>Staking Address set!</b><br>Now go ahead and stake!',
    STAKE_NOT_SEND:
        'Here senpai❣ use da <b>Stake</b> scween, Not da send scween, baka!', //'Here, use the <b>Stake</b> screen, not the Send screen!',
    BAD_ADDR_LENGTH:
        '<b>Invawed Game-Frag addwess!</b><br>Bad wength ({addressLength})', //'<b>Invalid Game-Frag address!<b><br>Bad length ({addressLength})',
    BAD_ADDR_PREFIX:
        '<b>Invawed Game-Frag addwess! Baka!</b><br>Bad pwefix {address} (Should start with {addressPrefix})', //'<b>Invalid Game-Frag address!<b><br>Bad prefix {address} (Should start with {addressPrefix})',
    ...
    UNABLE_SWITCH_TESTNET:
        '<b>Unable to switch Testnet Mowode!</b><br>A wawwet is alweady woaded✿', //<b>Unable to switch Testnet Mode!</b><br>A wallet is already loaded

    WALLET_OFFLINE_AUTOMATIC:
        '<b>Offwine Mowode is active!</b><br>Pwease disabwe Offwine Mowode for automatic twansactions', //"<b>Offline Mode is active!</b><br>Please disable Offline Mode for automatic transactions",
    WALLET_UNLOCK_IMPORT:
        'Pwease {unlock} your wawwet befowore sending twansactions!', //"Please {unlock} your wallet before sending transactions!",
    WALLET_FIREFOX_UNSUPPORTED:
        "Oh noes!<b>Firefox senpai doesn't sup<i>purr</i>t this!</b><br>Unfortunatewy, Firefox senpai does not sup<i>purr</i>t hawdware wawwets", //"<b>Firefox doesn't support this!</b><br>Unfortunately, Firefox does not support hardware wallets",
    WALLET_HARDWARE_WALLET:
        '<b>Hawdware wawwet ready!</b><br>Pwease keep your {hardwareWallet} pwugged in, unwocked, and in da Game-Frag app ♥', //"<b>Hardware wallet ready!</b><br>Please keep your {hardwareWallet} plugged in, unlocked, and in the Game-Frag app",
    ...
    CONFIRM_POPUP_VOTE_HTML:
        'Are you suuure? It takes 60 minutes to change yowour vowote', //Are you sure? It takes 60 minutes to change vote
