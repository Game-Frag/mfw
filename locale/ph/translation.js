export default {
    ...
    // Footer
    footerBuiltWithPivxLabs: 'Binuo nang may 💜 ng Game-Frag 🇵🇭', //Built with 💜 by Game-Frag

    // Intro
    loading: 'Loading', //Loading
    loadingTitle: 'My Game-frag wallet ay', //My Game-Frag Wallet is
    ...
    dCardOneDesc:
        "Gumawa ng bagong Game-Frag wallet, ito'y nag aalok ng pinaka-ligtas na backup at mga paraang pang seguridad", //Create a new Game-Frag wallet, offering the most secure backup & security methods.
    ...
    dCardThreeDesc:
        'Gamitin ang iyong Ledger Hardware Wallet na pamilyar sa interface ng MFW', //Use your Ledger Hardware wallet with MFW's familiar interface.
    ...
    dCardFourDesc:
        'I-import ang iyong Game-Frag wallet gamit ang Private Key, xpriv, o Seed Phrase', //Import a Game-Frag wallet using a Private Key, xpriv, or Seed Phrase.
    ...
    encryptFirstForContacts:
        'Sa sandaling mapindot mo ang "{button}" sa Dashboard, maaari kang lumikha ng Contact upang gawing mas madali ang pagtanggap ng FRAG!', //Once you hit "{button}" in the Dashboard, you can create a Contact to make receiving FRAG easier!
    ...
    pivxPromos:
        'ay isang desentralisadong sistema para sa gift code na nag kakahalaga ng FRAG', // [...] is a decentralised system for gift codes worth FRAG
    // NOTE: on this line, if possible, leave 'Game-Frag Promos' untranslated
    redeemInput: "Ipasok and iyong 'Game-Frag Promos'code", //Enter your \'Game-Frag Promos\' code
    ...
    settingsPivxNode: 'Pumili ng Game-Frag node:', //Choose a Game-Frag node:
    ...
    time_to_sync:
        'Ang bawat segundo sa oras na tumatagal upang muling mag synchronize sa MFW.', //The time in seconds it took for MFW to last synchronise.
    transaction:
    ...
    popupSeedPhraseBadNote:
        'Ang seed phrase na ito ay pwedeng hindi wasto o hindi ito generated ng MFW.<br>Gusto mo bang tumuloy?', //The seed phrase is either invalid or was not generated by MFW.<br>Do you still want to proceed?
    ...
    popupProposalFinalisedNote:
        '<b>Binabati kita sa paglulunsad ng iyong proposal!</b><br>Ang mga may-ari ng Masternode ay pwedeng gumamit ng Vote Hash upang bumoto mula sa mga wallet maliban sa MFW, kaya siguraduhin idagdag ito sa iyong forum post, kung naaangkop!', //<b>Congratulations on launching your proposal!</b><br>Masternode owners can use your Vote Hash to vote from wallets other than MFW, so make sure to add this to your forum post, if applicable!
    ...
    INVALID_ADDRESS:
        '<b>Ang Game-Frag address na ito ay hindi wasto!</b><br> {address}', //<b>Invalid Game-Frag address!</b><br> {address}
    ...
    BAD_ADDR_LENGTH:
        '<b>Hindi wasto ang Game-Frag address!<b><br>Bad lenght({addressLength})', //<b>Invalid Game-Frag address!<b><br>Bad length ({addressLength})
    BAD_ADDR_PREFIX:
        '<b>Hindi wasto ang Game-Frag address!<b><br>Bad prefix{address} (Ito ay dapat nag sisimula sa{addressPrefix})', //<b>Invalid Game-Frag address!<b><br>Bad prefix {address} (Should start with {addressPrefix})
    ...
    WALLET_HARDWARE_WALLET:
        '<b>Handa na ang Hardware wallet!</b><br>Pakiusap panatilihin mo na ang {hardwareWallet} ay naka plugged in, naka bukas, at nasa Game-Frag app ', //<b>Hardware wallet ready!</b><br>Please keep your {hardwareWallet} plugged in, unlocked, and in the Game-Frag app
