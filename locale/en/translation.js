export default {
    ...
    // Footer
    footerBuiltWithPivxLabs: 'Built with 💜 by Game-Frag', //

    // Intro
    loading: 'Loading', //
    loadingTitle: 'My Game-Frag Wallet is', //
    ...
    dCardOneDesc:
        'Create a new Game-Frag wallet, offering the most secure backup & security methods.', //
    ...
    dCardThreeDesc:
        "Use your Ledger Hardware wallet with MFW's familiar interface.", //
    dCardThreeButton: 'Access my Ledger', //

    dCardFourTitle: 'Go to', //
    dCardFourSubTitle: 'My Wallet', //
    dCardFourDesc:
        'Import a Game-Frag wallet using a Private Key, xpriv, or Seed Phrase.', //
    ...
    encryptFirstForContacts:
        'Once you hit "{button}" in the Dashboard, you can create a Contact to make receiving FRAG easier!', //
    ...
    pivxPromos: 'is a decentralised system for gift codes worth FRAG', // [...] is a decentralised system for gift codes worth PIV
    // NOTE: on this line, if possible, leave 'Game-Frag Promos' untranslated
    redeemInput: "Enter your 'Game-Frag Promos' code", //Enter your 'Game-Frag Promos' code
    ...
    settingsPivxNode: 'Choose a Game-Frag node:', //
    ...
    popupSeedPhraseBadNote:
        'The seed phrase is either invalid or was not generated by MFW.<br>Do you still want to proceed?',
    ...
    popupProposalFinalisedNote:
        '<b>Congratulations on launching your proposal!</b><br>Masternode owners can use your Vote Hash to vote from wallets other than MFW, so make sure to add this to your forum post, if applicable!',
    ...
    INVALID_ADDRESS: '<b>Invalid Game-Frag address!</b><br> {address}',
    ...
    BAD_ADDR_LENGTH:
        '<b>Invalid Game-frag address!<b><br>Bad length ({addressLength})',
    BAD_ADDR_PREFIX:
        '<b>Invalid Game-Frag address!<b><br>Bad prefix {address} (Should start with {addressPrefix})',
    ...
    WALLET_HARDWARE_WALLET:
        '<b>Hardware wallet ready!</b><br>Please keep your {hardwareWallet} plugged in, unlocked, and in the Game-Frag app',
