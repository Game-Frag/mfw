export default {
    ...
    // Footer
    footerBuiltWithPivxLabs: 'Gemaakt met 💜 door Game-Frag', //

    // Intro
    loading: 'Bezig met laden', //
    loadingTitle: 'Mijn Game-Frag-portemonnee is', //
    ...
    dCardOneDesc:
        'Maak een nieuwe Game-Frag-portemonnee aan, met de meest veilige back-up- en beveiligingsmethoden.', //
    ...
    dCardThreeDesc:
        'Gebruik uw Ledger Hardware-portemonnee met de vertrouwde interface van MFW.', //
    dCardThreeButton: 'Toegang tot mijn Ledger', //

    dCardFourTitle: 'Ga naar', //
    dCardFourSubTitle: 'Mijn Portemonnee', //
    dCardFourDesc:
        'Importeer een Game-Frag-portemonnee met een privésleutel, xpriv, of seedzin.', //
    ...
    encryptFirstForContacts:
        'Zodra je "{button}" in het Dashboard selecteert, kun je een contact aanmaken om het ontvangen van FRAG gemakkelijker te maken!', //
    ...
    pivxPromos:
        'is een gedecentraliseerd systeem voor cadeaucodes ter waarde van FRAG', // [...] is a decentralised system for gift codes worth FRAG
    // NOTE: on this line, if possible, leave 'Game-Frag Promos' untranslated
    redeemInput: 'Voer uw "Game-Frag Promos" code in', //Enter your 'Game-Frag Promos' code
    ...
    mnSubtext:
        'Vanuit dit tabblad kunt u één of meer masternodes maken en openen', //
    ...
    settingsPivxNode: 'Kies een Game-Frag-knooppunt:', //
    ...
    time_to_sync:
        'De tijd in seconden die MFW nodig had om voor het laatst te synchroniseren.',
    transaction:
    ...
    popupWalletWipe: 'Wil je je privégegevens van de portemonnee wissen?',
    popupWalletLockNote:
        'Je moet je wachtwoord invoeren om toegang te krijgen tot je geld',
    popupWalletWipeNote:
        'Je verliest de toegang tot je geld als je je privésleutel of seedzin niet hebt back-upped',
    popupSeedPhraseBad: 'Onverwachte seedzin',
    popupSeedPhraseBadNote:
        'De seedzin is ofwel ongeldig of is niet gegenereerd door MFW.<br>Wil je nog steeds doorgaan?',
    ...
    NEW_PASSWORD_SUCCESS:
        '<b>Je bent beveiligd! 🔐</b><br>Goed gedaan!',
    ...
    INVALID_ADDRESS: '<b>Ongeldig Game-Frag-adres!</b><br> {address}',
    ...
    BAD_ADDR_LENGTH:
        '<b>Ongeldig Game-Frag-adres!<b><br>Slechte lengte ({addressLength})',
    BAD_ADDR_PREFIX:
        '<b>Ongeldig Game-Frag-adres!<b><br>Ongeldige prefix {address} (Moet beginnen met {addressPrefix})',
    SENT_NOTHING: "Je kunt 'niets' niet versturen!",
    MORE_THEN_8_DECIMALS: '8 decimale limiet overschreden',
    SAVE_WALLET_PLEASE:
        '<b>Sla je portemonnee op!</b><br>Dashboard ➜ Beveilig je portemonnee',
    ...
    MN_BAD_PRIVKEY: 'De privésleutel is ongeldig',
    ...
    WALLET_HARDWARE_WALLET:
        '<b>Hardware wallet klaar!</b><br>Houd je {hardwareWallet} aangesloten, ontgrendeld en in de Game-Frag-app',
    ...
    CONFIRM_POPUP_MN_P_KEY_HTML:
        '<br> Bewaar deze privésleutel en kopieer deze naar je VPS-configuratie <br>',
    ...
    APP_INSTALLED: 'App geïnstalleerd!',
};
