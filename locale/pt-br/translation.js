export default {
    ...
    // Footer
    footerBuiltWithPivxLabs: 'Construido com 💜 por Game-Frag 🇧🇷', //Built with 💜 by Game-Frag

    // Intro
    loading: 'Carregando', //Loading
    loadingTitle: 'A Minha Carteira Game-Frag', //My Game-Frag Wallet is
    ...
    dCardOneDesc:
        'Crie uma carteira nova Game-Frag, oferecendo os métodos de backup e segurança mais seguros.', //Create a new Game-Frag wallet, offering the most secure backup & security methods.
    ...
    dCardThreeDesc:
        'Use a sua carteira de Hardware Ledger com a interface familiar do MFW.', //Use your Ledger Hardware wallet with MFW's familiar interface.
    ...
    dCardFourDesc:
        'Importar uma carteira Game-Frag usando uma chave privada, xpriv ou Seed Phrase.', //Import a Game-Frag wallet using a Private Key, xpriv, or Seed Phrase.
    ...
    encryptFirstForContacts:
        'Quando você pressionar "{button}" no dashboard você poderá criar um contato para receber FRAG mais facilmente! ', //Once you hit "{button}" in the Dashboard, you can create a Contact to make receiving FRAG easier!
    ...
    pivxPromos:
        'é um sistema descentralizado de códigos de presente com valor em FRAG', // [...] is a decentralised system for gift codes worth FRAG
    // NOTE: on this line, if possible, leave 'Game-Frag Promos' untranslated
    redeemInput: "Digite o seu código 'Game-Frag Promos'", //Enter your 'Game-Frag Promos' code
    ...
    settingsPivxNode: 'Escolha um node Game-Frag:', //Choose a Game-Frag node:
    ...
    time_to_sync:
        '"O tempo em segundos que o MFW levou para sincronizar pela última vez."', //The time in seconds it took for MFW to last synchronise.
    transaction:
    ...
    popupSeedPhraseBadNote:
        'A Seed Phrase é inválida ou não foi gerada pelo MFW.<br>Você ainda quer continuar', //The seed phrase is either invalid or was not generated by MFW.<br>Do you still want to proceed?
    ...
    popupProposalFinalisedNote:
        '<b>Parabéns pelo lançamento da sua proposta!</b><br>Os proprietários do Masternode podem usar a sua votação de hash em outras carteiras que não sejam MFW, então certifique-se de adicionar isso à sua publicação no fórum, se aplicável!', //<b>Congratulations on launching your proposal!</b><br>Masternode owners can use your Vote Hash to vote from wallets other than MFW, so make sure to add this to your forum post, if applicable!
    ...
    INVALID_ADDRESS: '<b>Endereço Game-Frag inválido!</b><br> {address}', //<b>Invalid Game-Frag address!</b><br> {address}
    ...
    BAD_ADDR_LENGTH:
        '<b>Endereço Game-Frag inválido!<b><br>Comprimento incorreto ({addressLength})', //<b>Invalid Game-Frag address!<b><br>Bad length ({addressLength})
    BAD_ADDR_PREFIX:
        '<b>Endereço Game-Frag inválido!<b><br>Prefixo inválido {address} (Deve começar com {addressPrefix})', //<b>Invalid Game-Frag address!<b><br>Bad prefix {address} (Should start with {addressPrefix})
    ...
    WALLET_HARDWARE_WALLET:
        '<b>Carteira de hardware pronta!</b><br>Mantenha a sua {hardwareWallet} conectada, desbloqueada e na aplicação Game-Frag', //<b>Hardware wallet ready!</b><br>Please keep your {hardwareWallet} plugged in, unlocked, and in the Game-Frag app
