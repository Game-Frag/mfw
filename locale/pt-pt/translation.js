export default {
    ...
    dCardThreeDesc:
        'Use a sua carteira Ledger Hardware com a interface familiar do MFW.', //Use your Ledger Hardware wallet with MFW's familiar interface.
    ...
    dCardFourDesc:
        'Importar uma carteira Game-Frag usando uma chave privada, xpriv ou Frase Inicial.', //Import a Game-Frag wallet using a Private Key, xpriv, or Seed Phrase.
    ...
    encryptFirstForContacts:
        'Depois de clicar no "{button}" no Painel de Controlo, pode criar um Contacto para facilitar a receção de FRAG!', //Once you hit "{button}" in the Dashboard, you can create a Contact to make receiving FRAG easier!
    ...
    pivxPromos:
        'é um sistema descentralizado de códigos de presente no valor de FRAG', // [...] is a decentralised system for gift codes worth FRAG
    ...
    time_to_sync:
        '"O tempo em segundos que o MFW levou a sincronizar pela última vez."', //The time in seconds it took for MFW to last synchronise.
    transaction:
    ...
    popupSeedPhraseBadNote:
        'A frase inicial é inválida ou não foi gerada pelo MFW.<br>Você ainda quer continuar', //The seed phrase is either invalid or was not generated by MFW.<br>Do you still want to proceed?
