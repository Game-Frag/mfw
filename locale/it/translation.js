export default {
    ...
    // Footer
    footerBuiltWithPivxLabs: 'Costruito col 💜 da Game-Frag 🇮🇹', //Built with 💜 by Game-Frag

    // Intro
    loading: 'Caricamento', //Loading
    loadingTitle: 'Il mio Wallet Game-Frag', //My Game-Frag Wallet is
    ...
    dCardOneDesc:
        'Crea un nuovo Wallet Game-Frag, con metodi di sicurezza & di backup più sicuri.', //Create a new Game-Frag wallet, offering the most secure backup & security methods.
    ...
    dCardThreeDesc:
        'Utilizza il tuo wallet Ledger con la solita interfaccia di MFW.', //Use your Ledger Hardware wallet with MFW's familiar interface.
    dCardThreeButton: 'Accedi al mio Ledger', //Access my Ledger

    dCardFourTitle: 'Vai al ', //Go to
    dCardFourSubTitle: 'Mio Wallet', //My Wallet
    dCardFourDesc:
        'Importa un wallet Game-Frag usando una Chiave Privata, xpriv, o una Seed Phrase.', //Import a Game-Frag wallet using a Private Key, xpriv, or Seed Phrase.
    ...
    encryptFirstForContacts:
        'Dopo aver premuto "{button}" nella Dashboard, puoi creare un contatto per facilitare la ricezione dei FRAG!', //Once you hit "{button}"in the Dashboard, you can create a Contact to make receiving FRAG easier!
    ...
    pivxPromos: 'è un sistema decentralizzato per codici regalo con valore FRAG', // [...] is a decentralised system for gift codes worth FRAG
    // NOTE: on this line, if possible, leave 'Game-Frag Promos' untranslated
    redeemInput: "Inserisci il tuo codice 'Game-Frag Promos'", //Enter your 'Game-Frag Promos' code
    ...
    settingsPivxNode: 'Scegli un nodo Game-Frag', //Choose a Game-Frag node:
    ...
    time_to_sync:
        "Il tempo in secondi impiegato da MFW per l'ultima sincronizzazione.", //The time in seconds it took for MFW to last synchronise.
    transaction:
    ...
    popupColdStakeNote:
        "Con un Cold Address puoi mettere in stake i tuoi FRAGs anche usando l'address di uno sconosciuto, che non potrà spenderli!", //A Cold Address stakes coins on your behalf, it cannot spend coins, so it's even safe to use a stranger's Cold Address!
    ...
    popupSeedPhraseBadNote:
        'La frase seed non è valida o non è stata generata da MFW.<br>Vuoi comunque procedere?', //The seed phrase is either invalid or was not generated by MFW.<br>Do you still want to proceed?
    ...
    INVALID_ADDRESS: '<b>Indirizzo Game-Frag non valido!</b><br> {address}', //<b>Invalid Game-Frag address!</b><br> {address}
    ...
    BAD_ADDR_LENGTH:
        '<b>Indirizzo Game-Frag non valido!<b><br>Lunghezza errata ({addressLength})', //<b>Invalid Game-Frag address!<b><br>Bad length ({addressLength})
    BAD_ADDR_PREFIX:
        '<b>Indirizzo Game-Frag non valido!<b><br>Prefisso {address} errato (dovrebbe iniziare con {addressPrefix})', //<b>Invalid Game-Frag address!<b><br>Bad prefix {address} (Should start with {addressPrefix})
    ...
    WALLET_HARDWARE_WALLET:
        "<b>Wallet hardware pronto!</b><br>Tieni il tuo {hardwareWallet} collegato, sbloccato e nell'app Game-Frag", //<b>Hardware wallet ready!</b><br>Please keep your {hardwareWallet} plugged in, unlocked, and in the Game-Frag app
