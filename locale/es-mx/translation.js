export default {
    ...
    // NOTA: Las variables que inserta MPW se denotan con corchetes {}, por ejemplo, {button}, NO traduzcas las variables, pero colócalas donde tenga más sentido.
    ...
    // Footer
    footerBuiltWithPivxLabs: 'Hecho con 💜 por Game-Frag 🇲🇽', //Built with 💜 by Game-Frag

    // Intro
    loading: 'Cargando', //Loading
    loadingTitle: 'My Game-Fage Wallet está', //My Game-Frag Wallet is
    ...
    dCardOneDesc:
        'Crear una nueva Game-Frag Wallet, ofreciendo los métodos de respaldo y seguridad más seguros.', //Create a new Game-Frag wallet, offering the most secure backup & security methods.
    dCardOneButton: 'Crear una nueva Game-Frag Wallet', //Create A New Wallet
    ...
    dCardThreeDesc:
        'Utiliza tu wallet Ledger Hardware con en la interfaz de MPW.', //Use your Ledger Hardware wallet with MPW's familiar interface.
    dCardThreeButton: 'Acceder a mi Ledger', //Access my Ledger

    dCardFourTitle: 'Ir a', //Go to
    dCardFourSubTitle: 'Mi Wallet', //My Wallet
    dCardFourDesc:
        'Importar una wallet de Game-Frag usando una llave privada, xpriv o frase de semilla.', //Import a Game-Frag wallet using a Private Key, xpriv, or Seed Phrase.
    ...
    encryptFirstForContacts:
        'Una vez que pulses "{button}" en el Panel de control, podrás crear un Contacto para facilitar la recepción de FRAG.', //Once you hit "{button}" in the Dashboard, you can create a Contact to make receiving FRAG easier!
    ...
    pivxPromos:
        'es un sistema descentralizado de códigos de regalo comprados con FRAG', // [...] is a decentralised system for gift codes worth FRAG
    // NOTE: on this line, if possible, leave 'Game-Frag Promos' untranslated
    redeemInput: 'Introduce tu código de Game-Frag Promos', //Enter your 'Game-Frag Promos' code
    ...
    settingsPivxNode: 'Elige un nodo Game-Frag:', //Choose a Game-Frag node:
    ...
    time_to_sync:
        'El tiempo en segundos que tardó MPW en sincronizarse por última vez.', //The time in seconds it took for MPW to last synchronise.
    transaction:
    ...
    popupSeedPhraseBadNote:
        'La frase de semilla no es válida o no ha sido generada por MFW.<br>¿Aún así deseas continuar?', //The seed phrase is either invalid or was not generated by MFW.<br>Do you still want to proceed?
    ...
    popupProposalFinalisedNote:
        '<b>¡Felicitaciones por el lanzamiento de tu propuesta!</b><br>¡Los propietarios de Masternode pueden utilizar tu Hash de Votación para votar desde wallets que no sean MFW, así que asegúrate de añadirlo a tu mensaje en el foro, si aplica!', //<b>Congratulations on launching your proposal!</b><br>Masternode owners can use your Vote Hash to vote from wallets other than MPW, so make sure to add this to your forum post, if applicable!
    ...
    INVALID_ADDRESS: '<b>¡Dirección Game-Frag no válida!</b><br> {address}', //<b>Invalid Game-Frag address!</b><br> {address}
    ...
    NEW_PASSWORD_SUCCESS:
        '<b>¡Estás asegurado! 🔐</b><br>¡Buen trabajo, eres un precavido!', //<b>You\'re Secured! 🔐</b><br>Nice stuff!
    ...
    BAD_ADDR_LENGTH:
        '<b>¡Dirección Game-Frag no válida!<b><br>Longitud incorrecta ({addressLength})', //<b>Invalid Game-Frag address!<b><br>Bad length ({addressLength})
    BAD_ADDR_PREFIX:
        '<b>¡Dirección Game-Frag no válida!<b><br>Prefijo {address} incorrecto (debe comenzar con {addressPrefix})', //<b>Invalid Game-Frag address!<b><br>Bad prefix {address} (Should start with {addressPrefix})
    ...
    WALLET_HARDWARE_WALLET:
        '<b>¡Listo para la wallet de hardware!</b><br>Manten tu {hardwareWallet} conectada, desbloqueada y en la aplicación Game-Frag.', //<b>Hardware wallet ready!</b><br>Please keep your {hardwareWallet} plugged in, unlocked, and in the Game-Frag app
