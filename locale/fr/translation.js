export default {
    ...
    // Footer
    footerBuiltWithPivxLabs: 'Construit avec 💜 par Game-Frag FR 🇫🇷', //Built with 💜 by Game-Frag

    // Intro
    loading: 'Chargement', //Loading
    loadingTitle: 'Mon portefeuille Game-Frag', //My Game-Frag Wallet is
    ...
    dCardOneDesc:
        'Créer un nouveau portefeuille Game-Frag, qui offre les méthodes de sauvegarde et de sécurité les plus sûres.', //Create a new Game-Frag wallet, offering the most secure backup & security methods.
    ...
    dCardThreeDesc:
        "Utilisez votre portefeuille Ledger Hardware avec l'interface familière de l'application MFW.", //Use your Ledger Hardware wallet with MFW's familiar interface.
    ...
    dCardFourDesc:
        "Importer un portefeuille Game-Frag à l'aide d'une clé privée, d'un xpriv ou d'une phrase de démarrage.", //Import a Game-Frag wallet using a Private Key, xpriv, or Seed Phrase.
    ...
    encryptFirstForContacts:
        'Une fois que vous avez touché "{button}" dans le tableau de bord, vous pouvez créer un contact pour faciliter la réception des FRAG !', //Once you hit "{button}" in the Dashboard, you can create a Contact to make receiving FRAG easier!
    ...
    pivxPromos:
        "est un système décentralisé de codes cadeaux d'une valeur de FRAG", // [...] is a decentralised system for gift codes worth FRAG
    // NOTE: on this line, if possible, leave 'Game-Frag Promos' untranslated
    redeemInput: "Introduisez votre code 'Game-Farg Promos'", //Enter your 'Game-Frag Promos' code
    ...
    settingsPivxNode: 'Choisir un node Game-Frag :', //Choose a Game-Frag node:
    ...
    popupSeedPhraseBadNote:
        "La phrase de semence est soit invalide, soit n'a pas été généré par MFW.<br>Voulez-vous toujours continuer ?", //The seed phrase is either invalid or was not generated by MFW.<br>Do you still want to proceed?
    ...
    popupProposalFinalisedNote:
        "<b>Félicitations pour le lancement de votre proposition!</b><br>Les propriétaires de Masternodes peuvent utiliser votre Hash de vote pour voter à partir de portefeuilles autres que MFW, alors assurez-vous d'ajouter ceci à votre message sur le forum, le cas échéant!", //<b>Congratulations on launching your proposal!</b><br>Masternode owners can use your Vote Hash to vote from wallets other than MFW, so make sure to add this to your forum post, if applicable!
    ...
    INVALID_ADDRESS: '<b>Adresse Game-Frag non valide !</b><br> {address}', //<b>Invalid Game-Frag address!</b><br> {address}
    ...
    BAD_ADDR_LENGTH:
        '<b>Adresse Game-Frag non valide!<b><br>Préfixe non valide {address} (Vous devez commencer par{addressPrefix})', //<b>Invalid Game-Frag address!<b><br>Bad length ({addressLength})
    BAD_ADDR_PREFIX:
        '<b>Adresse Game-Frag non valide!<b><br>Préfixe non valide {address} (Vous devez commencer par{addressPrefix})', //<b>Invalid Game-Frag address!<b><br>Bad prefix {address} (Should start with {addressPrefix})
    ...
    WALLET_HARDWARE_WALLET:
        "<b>Portefeuille de Hardware prêt!</b><br>Gardez votre {hardwareWallet} connecté, déverrouillé et dans l'application Game-Frag", //<b>Hardware wallet ready!</b><br>Please keep your {hardwareWallet} plugged in, unlocked, and in the Game-Frag app
